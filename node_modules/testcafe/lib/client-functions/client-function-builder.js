...
var _compileClientFunction = require('../compiler/es-next/compile-client-function');
...
var ClientFunctionBuilder = function () {
    ...
    ClientFunctionBuilder.prototype.getFunction = function getFunction() {
        ...
        var clientFn = function __$$clientFunction$$() {
            ...
            var callsite = (0, _getCallsite2.default)(builder.callsiteNames.execution);
            var args = [];
    ...
    ClientFunctionBuilder.prototype._executeCommand = function _executeCommand(args, testRun, callsite) {
        ...
        return _resultPromise2.default.fromFn((0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee() {
            var err, result;
