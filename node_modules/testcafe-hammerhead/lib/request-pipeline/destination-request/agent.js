...
var agents = (_agents = {}, _agents[TYPE.SSL3] = {
    instance: null,
...
function assign(reqOpts) {
    ...
    if (proxy) {
        if (reqOpts.protocol === 'http:') reqOpts.agent = new _httpProxyAgent2.default(proxy);else reqOpts.agent = new _httpsProxyAgent2.default(proxy);
...
function resetKeepAliveConnections() {
    (0, _keys2.default)(agents).forEach(function (type) {
        var agent = agents[type];
