...
var Session = function (_EventEmitter) {
    ...
    Session.prototype.setExternalProxySettings = function setExternalProxySettings(url, ignoreHosts) {
        this.externalProxySettings = null;

        if (typeof url !== 'string') return;

        url = url.replace(/^(https?:)?(\/\/)?/g, function (match, protocol, slashes) {
        ...
        if (ignoreHosts && Array.isArray(ignoreHosts)) {
            for (var i = 0; i < ignoreHosts.length; i++) {
                if (ignoreHosts[i] && typeof ignoreHosts[i] === 'string') ignore.push(ignoreHosts[i]);
            }
        }
    ...
    Session.prototype.onPageRequest = function onPageRequest() {
...
ServiceMessages[_command2.default.setCookie] = function (msg) {
...
ServiceMessages[_command2.default.uploadFiles] = function () {
    var _ref2 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee2(msg) {
...
ServiceMessages[_command2.default.getUploadedFiles] = function () {
    var _ref3 = (0, _asyncToGenerator3.default)(_regenerator2.default.mark(function _callee3(msg) {
